...
(function($PS) {
  ...
  var turnCW = function (heading) {
      if (heading instanceof North) {
          return East.value;
      };
      if (heading instanceof South) {
          return West.value;
      };
      if (heading instanceof East) {
          return South.value;
      };
      if (heading instanceof West) {
          return North.value;
      };
      throw new Error("Failed pattern match at Main (line 60, column 3 - line 64, column 18): " + [ heading.constructor.name ]);
  };
  var turnCCW = function ($35) {
      return turnCW(turnCW(turnCW($35)));
  };
  var showHeading = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 31, column 1 - line 35, column 21): " + [ v.constructor.name ]);
  });
  var move = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 44, column 3 - line 56, column 27): " + [ v.heading.constructor.name ]);
  };
  ...
  var grid = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (c) {
          ...
          if ($23) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell" ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("/robot-" + (Data_Show.show(showHeading)(v.heading) + ".png")), Halogen_HTML_Properties.classes([ "robot" ]) ]) ]);
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell" ]) ])([  ]);
      })(Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(1)(5))(function (n) {
          return [ {
              row: n,
              col: 1
          }, {
  ...
  var render = function (state) {
          return Halogen_HTML_Elements.div_([ grid(state) ]);
      };
  ...
  var handleAction = function (dictMonadAff1) {
          return function (v) {
              if (v instanceof Init) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                      return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff1)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $36 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKey.create(sid));
                              return function ($37) {
                                  return $36(Web_UIEvent_KeyboardEvent.fromEvent($37));
                              };
                          })());
                      });
                  });
              ...
              if (v instanceof HandleKey) {
                  if (Web_UIEvent_KeyboardEvent.key(v.value1) === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              return move(state);
                          });
                      });
                  };
                  if (Web_UIEvent_KeyboardEvent.key(v.value1) === "ArrowLeft") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              var $27 = {};
                              for (var $28 in state) {
                              ...
                              $27.heading = turnCCW(state.heading);
                              return $27;
                          });
                      });
                  };
                  if (Web_UIEvent_KeyboardEvent.key(v.value1) === "ArrowRight") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              var $30 = {};
                              for (var $31 in state) {
                              ...
                              $30.heading = turnCW(state.heading);
                              return $30;
                          });
                      });
                  };
              ...
              throw new Error("Failed pattern match at Main (line 102, column 18 - line 121, column 20): " + [ v.constructor.name ]);
          };
      };
  ...
  exports["showHeading"] = showHeading;
})(PS);
PS["Main"].main();