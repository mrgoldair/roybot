...
(function($PS) {
  ...
  var turnCCW = function ($33) {
      return turnCW(turnCW(turnCW($33)));
  };
  ...
  var grid = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (c) {
          ...
          if ($23) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell" ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("/robot-" + (Data_Show.show(showHeading)(v.heading) + ".svg")), Halogen_HTML_Properties.classes([ "robot" ]) ]) ]);
          };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Forward.value);
          }) ])([ Halogen_HTML_Core.text("+") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "col";
          ...
          }) ])([ Halogen_HTML_Core.text("<-") ]), grid(state) ]);
      };
      ...
      var handleAction = function (action) {
          ...
          if (action instanceof CW) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $27.heading = turnCW(state.heading);
                  return $27;
              });
          };
          if (action instanceof CCW) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $30.heading = turnCCW(state.heading);
                  return $30;
              });
          };
          throw new Error("Failed pattern match at Main (line 100, column 5 - line 106, column 72): " + [ action.constructor.name ]);
      };
