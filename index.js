...
(function($PS) {
  ...
  var gridCell = function (d) {
      return function (s) {
          return function (r) {
              return function (c) {
                  var n = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(d)(s);
                  return new Data_Tuple.Tuple(n * r | 0, n * c | 0);
              };
          };
      };
  };
  var grid = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "grid" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "cell" ]) ])([ Halogen_HTML_Core.text("div") ]);
  })(Data_Array.range(1)(25)));
  var component = (function () {
      var render = function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Increment.value);
          }) ])([ Halogen_HTML_Core.text("+") ]), grid ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 101, column 18 - line 105, column 36): " + [ v.constructor.name ]);
      };
